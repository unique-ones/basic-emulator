...
static s32 s32_max(s32 a, s32 b);

/// Returns the smaller of the two passed variables
/// @param a The first variable
/// @param b The second variable
/// @return The min value
static s32 s32_min(s32 a, s32 b);
...
static s32 s32_clamp(s32 n, s32 min, s32 max);

/// Returns the greater of the two passed variables
/// @param a The first variable
/// @param b The second variable
/// @return The max value
static s64 s64_max(s64 a, s64 b);

/// Returns the smaller of the two passed variables
/// @param a The first variable
/// @param b The second variable
/// @return The min value
static s64 s64_min(s64 a, s64 b);
...
/// @param max The upper bound
/// @return The clamped value
static s64 s64_clamp(s64 n, s64 min, s64 max);
...
static void f32mat4_create_orthogonal(F32Mat4 *self, f32 left, f32 right, f32 bottom, f32 top);
